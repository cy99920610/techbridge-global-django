...
SECRET_KEY = config('SECRET_KEY', default='dev-only-change-me-techbridge-global')
DEBUG = config('DEBUG', default=True, cast=bool)

_allowed_hosts = config('ALLOWED_HOSTS', default='127.0.0.1,localhost').split(',')
...
ROOT_URLCONF = 'techbridge_global.urls'
...
WSGI_APPLICATION = 'techbridge_global.wsgi.application'
